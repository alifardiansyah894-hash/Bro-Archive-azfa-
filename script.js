...
const friendProfile = {
  ...
  thoughts: [
    "Mungkin nanti kita akan berjalan di tempat yang berbeda, bertemu o rang-orang baru, dan nggak sesering sekarang. Tapi berbeda jalan bukan berarti semua yang pernah kita lalui harus hilang.",
...
(function () {
  ...
  // Ganti nilai ini kalau mau bikin archive baru buat Dzulhi/Abdilah — HARUS beda per orang
  const LEAVE_MESSAGE_SECRET_ID = 'azf-9x7kq2mfh83lp';
...
document.addEventListener('archive:enter', function () {
    ...
    // Autoplay lagu utama (Lemon Tree) begitu archive dibuka
    const audio = document.getElementById('bg-audio');
